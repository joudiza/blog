...
# Custom Imports
from posts import serializer as api_serializer
from posts import models as api_models
...
class DashboardMarkNotiSeenAPIView(APIView):
    permission_classes = [AllowAny]  # يفضل استعمال IsAuthenticated فالحماية
    ...
    @swagger_auto_schema(
        ...
        responses={200: 'Noti Marked As Seen', 404: 'Notification Not Found'}
    )
    def post(self, request):
